...
def check_invariants(processes=None) -> list:
    ...
    return [
        {"check": "single_meta_token_holder", "ok": len(token_holders) == 1, "detail": f"holders={token_holders}"},
        {"check": "meta_token_holder_is_daemon", "ok": token_holders == ["whatsvault-meta"], "detail": f"holders={token_holders}"},
